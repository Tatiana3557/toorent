...
function fontsStyle(params) {
    ...
    $(function(){
        $('.slider').slick({
            nextArrow: '<button class="slick-arorow slick-next"><img src="img/next.svg" alt="next arrow"></button>',
            prevArrow: '<button class="slick-arorow slick-prev"><img src="img/prev.svg" alt="prev arrow"></button>',
            fade: true,
            responsive: [
                {
                    breakpoint: 441,
